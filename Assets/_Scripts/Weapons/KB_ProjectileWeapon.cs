...
public class KB_ProjectileWeapon : KB_Weapon, IHasAmmo, IHasObjectPool {
	[SerializeField] private KB_ProjectileWeaponDataSO m_weaponDataSO;
	[SerializeField] private Transform m_muzzleTf;

	private Transform m_projectileObjectPoolParentTf;
	private ObjectPool<KB_Projectile> m_projectilePool;
	...
	private void Fire() {
		KB_Projectile newProjectile = m_projectilePool.Get();
	...
	public void ReleaseProjectileFromPool(KB_Projectile projectile) {
	...
	private void CreateProjectilePool() {
		...
		m_projectilePool = new ObjectPool<KB_Projectile>(
			() => {
				KB_Projectile projectile = Instantiate(m_weaponDataSO.projectilePrefab);
