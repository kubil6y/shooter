...
public class KB_WeaponManagerVisuals : MonoBehaviour {
	...
	private KB_WeaponManager m_weaponManager;
	...
	private void Awake() {
		m_weaponManager = GetComponent<KB_WeaponManager>();
	...
	private void HandleWeaponRotationVisual() {
		if (!m_weaponManager.HasAnyWeapon()) {
			return;
		}
	...
	private void WeaponManager_OnWeaponChanged(object sender, KB_Weapon weapon) {
